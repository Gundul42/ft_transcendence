...
function Dispatch({app_state, set_page, set_data, unreadRooms, setUnreadRooms} : {app_state: IAppState, set_page: any, set_data: any, unreadRooms: number, setUnreadRooms: any}) {
  let to_render: any;
  ...
  if (app_state.data === null) {
    ...
    switch (app_state.page.location) {
      case "user":
        return (<User app_state={safe_app_state} set_page={set_page}  unreadRooms={unreadRooms} />);
      case "chat":
        return (<Chat app_state={safe_app_state} set_page={set_page}  unreadRooms={unreadRooms} setUnreadRooms={setUnreadRooms} />);
      case "play" :
