...
export function PersonalInformation({user_state, full_name, email, uploadAvatar, setTwoFA} : {user_state: any, full_name: string, email: string, uploadAvatar: any, setTwoFA: any}) {
	return (
